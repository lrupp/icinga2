...
Value ClusterEvents::SetRemovalInfoAPIHandler(const MessageOrigin::Ptr& origin, const Dictionary::Ptr& params)
{
	...
	const String& objectType = params->Get("object_type");
	const String& objectName = params->Get("object_name");
	const String& removedBy = params->Get("removed_by");
	const double removeTime = params->Get("remove_time");
